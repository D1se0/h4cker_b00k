...
Funciona en la **capa 4 (Transporte)**: no basta con entender IPs (capa 3), debe entender también **puertos**. Por eso hablamos de **NAPT/PAT** (*Network/Port Address Translation*) como el nombre técnico del NAT moderno.
