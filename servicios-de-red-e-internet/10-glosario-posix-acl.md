...
* **ACL (Access Control List)** — Lista de reglas que define quién puede acceder a un recurso y qué puede hacer; en redes, filtra por IP/protocolo/puerto. → [10](10-glosario-posix-acl.md)
...
* **POSIX** — Estándares (IEEE 1003) de compatibilidad entre sistemas tipo Unix; Linux lo sigue mayormente pero no está certificado. → [10](10-glosario-posix-acl.md)
