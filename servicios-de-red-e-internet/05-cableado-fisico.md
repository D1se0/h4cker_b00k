...
> 📌 _Nota de tu apunte:_ "En RJ-49 se apantalla únicamente uno de los dos extremos".
...
> 📌 _Nota de tu apunte:_ "Primero hay que plantear la solución y luego hacerla físicamente" — en red, como en hacking: primero el diseño (qué red, qué cable, qué estándar), después el crimpeo.
