...
| 5 | [Funciones de Utilidad](./05-funciones-utilidad.md) | Cadena, matemáticas, fecha, window functions (LAG, LEAD, FIRST_VALUE...) | 🟠 Intermedio |
...
1. **Crea un Space nuevo** en tu GitBook ([h4cker_b00k](https://dise0.gitbook.io/h4cker_b00k)) llamado `SQL` (o una subcolección dentro del libro).
